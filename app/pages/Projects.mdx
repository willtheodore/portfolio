...
import bluffs1 from "../assets/bluffs1.png";
import bluffs2 from "../assets/bluffs2.png";
import bluffs3 from "../assets/bluffs3.png";
...
<ProjectShowcase title="Bedford Bluffs" url="www.bedfordbluffs.com" nodes={3}>
	<ProjectSlide photoURL={bluffs1}>
...
<ProjectShowcase title="Portfolio" nodes={1}>
	<ProjectSlide photoURL={portfolio}>
