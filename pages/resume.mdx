...
<LabeledIndent title="Relevant Courses:">
  Computer Architecture/Machine Level Programming*, Directed Research: CS*,
...
<LabeledIndent title="Java:">
  Used extensively in Emory coursework for building data structures and solving algorithm problems
</LabeledIndent>
...
> More detail on every project is available in the <Link href="/projects"><strong style={{ fontWeight: "bold", cursor: "pointer" }}>projects section</strong></Link> of my website.
